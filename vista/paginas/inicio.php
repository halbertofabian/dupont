    ...
    <div class="col-xl-4 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="py-4">
                    <span class="peity-line" data-width="100%" data-peity='{ "fill": ["rgba(228, 60, 51, 0.3)"],"stroke": ["rgba(228, 60, 51, 0.8)"]}' data-height="60">4,6,8,7,6,7,9,8,6,5,7,5,8,6,4,8,9,8,5,4</span>
                </div>
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-6">
                        <div class="text-center">
                            <span class="peity-pie" data-peity='{ "fill": ["#e2595f", "#f2f2f2"]}' data-width="60" data-height="60">70/100</span>
                        </div>
                    </div>
                </div>
                <div>
                            ...
                            <ul class="list-unstyled latest-message-list mb-0">
                                <li class="message-list-item">
                                    <a href="#" class="text-dark">
                                        <div class="media">
                                            <img class="mr-3 thumb-md rounded-circle" src="<?php echo $url ?>vista/assets/images/users/avatar-2.jpg" alt="">
                                ...
                                <li class="message-list-item">
                                    <a href="#" class="text-dark">
                                        <div class="media">
                                            <img class="mr-3 thumb-md rounded-circle" src="<?php echo $url ?>vista/assets/images/users/avatar-3.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li class="message-list-item">
                                    <a href="#" class="text-dark">
                                        <div class="media">
                                            <img class="mr-3 thumb-md rounded-circle" src="<?php echo $url ?>vista/assets/images/users/avatar-4.jpg" alt="">
                                            <div class="media-body">
                                ...
                                <li class="message-list-item">
                                    <a href="#" class="text-dark">
                                        <div class="media">
                                            <img class="mr-3 thumb-md rounded-circle" src="<?php echo $url ?>vista/assets/images/users/avatar-5.jpg" alt="">
                                            <div class="media-body">
                                                <h6 class="mt-0">Danny Benson</h6>
                        ...
                        <div class="p-2 mt-2">
                            <ul class="list-unstyled latest-message-list mb-0">
                                ...
                                <li class="message-list-item">
                                    <a href="#" class="text-dark">
                                        <div class="media">
                                            <img class="mr-3 thumb-md rounded-circle" src="<?php echo $url ?>vista/assets/images/users/avatar-6.jpg" alt="">
                                            <div class="media-body">
                                                <h6 class="mt-0">Danny Benson</h6>
                                                <p class="text-muted mb-0">I've finished it! See you so...</p>
                                ...
                                <li class="message-list-item">
                                    <a href="#" class="text-dark">
                                        <div class="media">
                                            <img class="mr-3 thumb-md rounded-circle" src="<?php echo $url ?>vista/assets/images/users/avatar-7.jpg" alt="">
                                            <div class="media-body">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="<?php echo $url ?>vista/assets/images/users/avatar-2.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Rafael Reardon
                                    </div>
                                </td>
                                <td>14/10/2018</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="<?php echo $url ?>vista/assets/images/users/avatar-3.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Thomas Hirsch
                                    </div>
                                </td>
                                <td>15/10/2018</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="<?php echo $url ?>vista/assets/images/users/avatar-4.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Archer Desaillly
                                    </div>
                                </td>
                                <td>15/10/2018</td>
                                <td><span class="badge badge-success">Delivered</span></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="<?php echo $url ?>vista/assets/images/users/avatar-5.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Michael Flannery
                                    </div>
                                </td>
                                <td>16/10/2018</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="<?php echo $url ?>vista/assets/images/users/avatar-6.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Jamie Fishbourne
                                    </div>
                                </td>
                                <td>17/10/2018</td>
                                <td><span class="badge badge-success">Delivered</span></td>
